...
def drivingLisence():
    ...
    label_dob = "21 September 2008"
    print(type(label_dob))
    label_pin = "382424"
    print(type(label_pin))
    label_address ="Indira Niwas, 15 Avantikabhai Gokhale Road, Girgaum ,Mumbai,Mahashtra"
    print(type(label_address))
    label_vehicle_type ="two wheel and 4 wheel vehicel "
